...
import type { APIActionRowComponent, APIAllowedMentions, APIChannel, APIEmbed, APIExtendedInvite, APIFollowedChannel, APIMessage, APIMessageActionRowComponent, APIMessageReference, APIThreadList, APIThreadMember, APIUser, ChannelType, InviteTargetType, MessageFlags, OverwriteType, ThreadAutoArchiveDuration, ThreadChannelType, VideoQualityMode, APIGuildForumTag, APIGuildForumDefaultReactionEmoji, SortOrderType, ForumLayoutType, ChannelFlags } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10';
import type { AddUndefinedToPossiblyUndefinedPropertiesOfInterface, StrictPartial } from '@discordjs/rest/node_modules/discord-api-types/utils/internals';
import type { RESTAPIPoll } from '@discordjs/rest/node_modules/discord-api-types/rest/v10/poll';
