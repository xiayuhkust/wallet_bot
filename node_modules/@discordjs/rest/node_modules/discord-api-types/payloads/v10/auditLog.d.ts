...
import type { APIAutoModerationAction, APIAutoModerationRule, APIAutoModerationRuleTriggerMetadata, AutoModerationRuleEventType, AutoModerationRuleTriggerType } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/autoModeration';
import type { APIChannel, APIGuildForumDefaultReactionEmoji, APIGuildForumTag, APIOverwrite } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/channel';
import type { APIGuildIntegration, APIGuildIntegrationType, GuildDefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, GuildSystemChannelFlags, GuildVerificationLevel, IntegrationExpireBehavior } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/guild';
import type { APIGuildScheduledEvent, GuildScheduledEventEntityType, GuildScheduledEventStatus } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/guildScheduledEvent';
import type { APIApplicationCommand } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/interactions';
import type { APIRole } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/permissions';
import type { StageInstancePrivacyLevel } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/stageInstance';
import type { StickerFormatType } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/sticker';
import type { APIUser } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/user';
import type { APIWebhook } from '@discordjs/rest/node_modules/discord-api-types/payloads/v10/webhook';
/**
